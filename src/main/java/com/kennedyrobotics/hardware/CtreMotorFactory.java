...
import com.kennedyrobotics.hardware.components.motor.LazyTalonFX;
import com.kennedyrobotics.hardware.components.motor.LazyTalonSRX;

/**
 * A class to create Falcon (TalonFX), TalonSRX, VictorSPX, and GhostTalonSRX objects.
 * Based on FRC Team 1816 The Green Machine's 2021 CtreMotorFactoru
